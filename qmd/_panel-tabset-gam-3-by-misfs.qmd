...
::: {#tbl-mbepr-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `mbepr_gam_3_by_misfs` model.
:::
...
::: {#tbl-beipr-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `beipr_gam_3_by_misfs` model.
:::
...
::: {#tbl-mbepr-beipr-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `mbepr_beipr_gam_3_by_misfs` model.
:::
...
::: {#tbl-maper-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `maper_gam_3_by_misfs` model.
:::
...
::: {#tbl-mpepr-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `mpepr_gam_3_by_misfs` model.
:::
...
::: {#tbl-maper-mpepr-gam-3-by-misfs-coef-stats}
```{r}
#| output: asis
...
Value of the coefficients in the `maper_mpepr_gam_3_by_misfs` model.
:::
